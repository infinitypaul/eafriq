							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="form.blade.php">Horizontal form</a></li>
									</ul>
								</li>
								<!-- /forms -->
								...
								<li>
									...
									<ul>
										...
										<li><a href="table.blade.php">Advanced examples</a></li>
								...
								<li>
									...
									<ul>
										<li><a href="blank.blade.php">Invoice template</a></li>
				...
				<div class="page-header">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="form.blade.php">Form layouts</a></li>
