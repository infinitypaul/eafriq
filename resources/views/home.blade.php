					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="active"><a href="homes.blade.php"><i class="icon-home4"></i> <span>Dashboard</span></a></li>
								<li>
									...
									<table class="table text-nowrap">
										...
										<tbody>
											...
											<tr>
												<td>
													<div class="media-left media-middle">
														<a href="#"><img src="{{asset('images/placeholder.jpg')}}" class="img-circle img-xs" alt=""></a>
													</div>
													<div class="media-left">
											...
											<ul class="media-list content-group">
												<li class="media stack-media-on-mobile">
				                					<div class="media-left">
														<div class="thumb">
															<a href="#">
																<img src="{{asset('images/placeholder.jpg')}}" class="img-responsive img-rounded media-preview" alt="">
								...
								<div class="tab-content">
									<div class="tab-pane active fade in has-padding" id="messages-tue">
										<ul class="media-list">
											<li class="media">
												<div class="media-left">
													<img src="{{asset('images/placeholder.jpg')}}" class="img-circle img-xs" alt="">
											...
											<li class="media">
												<div class="media-left">
													<img src="{{asset('images/placeholder.jp')}}g" class="img-circle img-xs" alt="">
												</div>
