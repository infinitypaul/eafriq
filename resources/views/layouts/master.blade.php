...
<head>
	...
	<link href="{{asset('assets/css/minified/bootstrap.min.css')}}" rel="stylesheet" >
	<link href="{{asset('assets/css/minified/core.min.css')}}" rel="stylesheet">
	<link href="{{asset('assets/css/minified/components.min.css')}}" rel="stylesheet" >
	<link href="{{asset('assets/css/minified/colors.min.css')}}" rel="stylesheet" >
	<!-- /global stylesheets -->
	...
	<script  src="{{asset('assets/js/core/app.js')}}"></script>
	<script  src="{{asset('assets/js/pages/invoice_template.js')}}"></script>
...
<body>
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.blade.php"><img src="{{asset('assets/images/logo_light.png')}}" alt=""></a>
    ...
    <div class="footer text-muted">
						&copy; 2015. <a href="#">Limitless Web App Kit</a> by infinitypaul
					</div>
					<!-- /footer -->
